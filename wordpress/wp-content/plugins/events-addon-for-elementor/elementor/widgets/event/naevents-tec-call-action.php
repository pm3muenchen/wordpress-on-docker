<?php
/*
 * Elementor Events Addon for Elementor TEC Call To Action Widget
...
if ( is_plugin_active( 'the-events-calendar/the-events-calendar.php' ) ) {
	...
	class Event_Elementor_Addon_TEC_CallToAction extends Widget_Base{

		/**
		 * Retrieve the widget name.
		*/
		public function get_name(){
			return 'naevents_tec_call_action';
		}
		...
		*/
		...
		/**
		 * Register Events Addon for Elementor TEC Call To Action widget controls.
	...
	Plugin::instance()->widgets_manager->register_widget_type( new Event_Elementor_Addon_TEC_CallToAction() );
}
