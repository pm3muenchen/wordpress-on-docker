<?php
/*
 * Elementor Events Addon for Elementor All-in-One Event Calendar Call To Action Widget
...
if ( is_plugin_active( 'all-in-one-event-calendar/all-in-one-event-calendar.php' ) ) {
	...
	class Event_Elementor_Addon_AOEC_CallToAction extends Widget_Base{

		/**
		 * Retrieve the widget name.
		*/
		public function get_name(){
			return 'naevents_aoec_call_action';
		}
	...
	Plugin::instance()->widgets_manager->register_widget_type( new Event_Elementor_Addon_AOEC_CallToAction() );
}
