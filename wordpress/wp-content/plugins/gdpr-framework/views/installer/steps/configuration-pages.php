...
<p>In WordPress admin, there is now a new page under the Tools menu item called "Data443 GDPR." Once you've finished the wizard, you can modify the plugin settings there.</p>
